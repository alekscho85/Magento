 ...
 */
class Extensa_Econt_Model_System_Config_Source_Officeaps
{
    /**
    ...
    {
        if (!$this->_options && Mage::helper('extensa_econt')->getStoreConfig('office_city_aps_id')) {
            $offices = Mage::getModel('extensa_econt/office')
                ->getCollection()
                ->setCityId(Mage::helper('extensa_econt')->getStoreConfig('office_city_aps_id'))
