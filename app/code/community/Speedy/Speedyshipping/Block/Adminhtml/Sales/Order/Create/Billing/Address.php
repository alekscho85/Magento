 ...
 * @author killer
 */
class Speedy_Speedyshipping_Block_Adminhtml_Sales_Order_Create_Billing_Address extends
Mage_Adminhtml_Block_Sales_Order_Create_Billing_Address{
    //put youllir code here
    ...
    protected function _prepareForm() {
        ...
        //$cityId= $this->_form->getElement('speedy_site_id')->getData();
        ...
        $speedyOfficeNameField = $fieldset->addField($speedyOfficeName->getId(),
                    'text',
                    $speedyOfficeName->getData(),
                    $this->_form->getElement('speedy_office_chooser')->getId()
                );
        ...
        $speedyQuarterField = $fieldset->addField($speedyQuarterName->getId(),
                    'text',
                    $speedyQuarterName->getData(),
                    $this->_form->getElement('speedy_office_chooser')->getId()
                );
        ...
        $speedyStreetField = $fieldset->addField($speedyStreetName->getId(),
                    'text',
                    $speedyStreetName->getData(),
                    $this->_form->getElement('speedy_quarter_name')->getId()
                );
        ...
        $speedyStreetNumberField = $fieldset->addField($speedyStreetNumber->getId(),
                    'text',
                    $speedyStreetNumber->getData(),
                    $this->_form->getElement('speedy_street_name')->getId()
                );
        ...
        $speedyBlockNumberField = $fieldset->addField($speedyBlokNumber->getId(),
                    'text',
                    $speedyBlokNumber->getData(),
                    $this->_form->getElement('speedy_street_number')->getId()
                );
        ...
        $speedyEntranceField = $fieldset->addField($speedyEntrance->getId(),
                    'text',
                    $speedyEntrance->getData(),
                    $this->_form->getElement('speedy_block_number')->getId()
                );
        ...
        $speedyFloorField = $fieldset->addField($speedyFloor->getId(),
                    'text',
                    $speedyFloor->getData(),
                    $this->_form->getElement('speedy_entrance')->getId()
                );
        ...
        $speedyApartmentField = $fieldset->addField($speedyApartment->getId(),
                    'text',
                    $speedyApartment->getData(),
                    $this->_form->getElement('speedy_floor')->getId()
                );
        ...
        $speedyAddressNoteField = $fieldset->addField($speedyAddressNote->getId(),
                    'text',
                    $speedyAddressNote->getData(),
                    $this->_form->getElement('speedy_apartment')->getId()
                );
